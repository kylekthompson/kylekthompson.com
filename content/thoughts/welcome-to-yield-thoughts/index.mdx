...
description: _An introduction to yield(thoughts) and my first attempt at blogging_
date: 2019-02-21
author: Kyle Thompson
bannerImage: ./images/banner.jpg
bannerCredit: Photo by [Adam Solomon](https://unsplash.com/photos/WHUDOzd5IYU)
...
Oh! One last thing (so I can test displaying code and in case anyone is curious)- the name of the blog comes from
